...
//                 </div>
//                 <br />
//                 <span className='text-sm font-medium text-gray-700'>Adjuntar: Emvia imagenes que ayuden a entender la incidencia, asi podremos ayudarte mas eficientemente. </span>
//                 <br />
//                 <input className='' id='photo' name='photo' type="file" />
//                 {error && <p className='text-red-500 text-sm'>{error}</p>}
//                 <button 
